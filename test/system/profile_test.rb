...
class ProfileTest < ApplicationSystemTestCase
  ...
  test "Edits own profile" do
    ...
    stub_request(:post, "http://localhost:3000/api/profile/complete").with(body: "{\"display_name\":\"bob tables\",\"about_me\":\"HEY WHAT DOES THIS DO?\",\"pronouns\":\"She/Her\",\"relationship_status\":\"single\",\"relationship_type\":\"non_monogamous\",\"tobacco\":\"never\",\"alcohol\":\"sometimes\",\"marijuana\":\"sometimes\",\"other_recreational_drugs\":null,\"kids\":\"have_not\",\"wants_kids\":\"do_not_want_any\",\"pets\":\"have\",\"wants_pets\":\"maybe\",\"religion\":\"atheism\",\"religion_importance\":\"not_important\",\"hide_age\":\"0\",\"languages\":[\"eng\"],\"genders\":[\"man\"],\"orientations\":[\"bisexual\"]}")
