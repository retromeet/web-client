...
OtherProfileInfo = Data.define(:display_name,
                               :genders,
                               :orientations,
                               :age,
                               :profile_picture,
  ...
  def distance
    ...
    "~#{format("%.1f", location_distance / 1_000)}km"
    end
  end
end
